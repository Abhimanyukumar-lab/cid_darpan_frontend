...
if (!window["google"]["loader"]) {
  ...
  google.loader.ServiceBase = "/assets/js/transliteration.I.js";
  ...
  (function () {
    ...
    function y(a) {
      return a in z
        ? z[a]
        : (z[a] = -1 != navigator.userAgent.toLowerCase().indexOf(a));
    }
    var z = {};
    function A(a, b) {
      var c = function () {};
    ...
    google.load = function (a, b, c) {
      function d(a) {
        ...
        "undefined" != typeof b[1] &&
          ((e = b[0]), (c.packages = c.packages || []), c.packages.push(b[1]));
      }
      var e = a;
      c = c || {};
      if (
    ...
    google.ca = function (a, b) {
      b
        ? (0 == I.length &&
            (J(window, "load", K),
            (!y("msie") && !y("safari") && !y("konqueror") && y("mozilla")) ||
            window.opera
              ? window.addEventListener("DOMContentLoaded", K, !1)
              : y("msie")
              ? document.write(
                  "<script defer onreadystatechange='google.loader.domReady()' src=//:>\x3c/script>"
                )
              : (y("safari") || y("konqueror")) && window.setTimeout(L, 10)),
          I.push(a))
        : J(window, "load", a);
    };
    ...
    google.loader.W = function () {
      ...
      "complete" == a.readyState &&
        ((a.onreadystatechange = null), a.parentNode.removeChild(a), K());
    };
    ...
    google.loader.f = function (a, b, c) {
      a: {
        var d = g.document;
        if (
          (d = d.querySelector && d.querySelector("script[nonce]")) &&
      ...
      if (c) {
        ...
        "script" == a
          ? ((e = '<script src="' + w(b) + '" type="text/javascript"'),
            d && (e += ' nonce="' + w(d) + '"'),
            document.write(e + ">\x3c/script>"))
          : "css" == a &&
            ((e = '<link href="' + w(b) + '" type="text/css" rel="stylesheet"'),
            d && (e += ' nonce="' + w(d) + '"'),
            document.write(e + "></link>"));
    };
    ...
    google.loader.aa = function (a) {
      if ((a = a.specs) && a.length)
        for (var b = 0; b < a.length; ++b) {
          ...
          "string" == typeof c
            ? (G[":" + c] = new P(c))
            : ((c = new Q(c.name, c.baseSpec, c.customSpecs)),
              (G[":" + c.name] = c));
        }
    };
    ...
    P.prototype.i = function (a, b) {
      ...
      if (!this.s) {
        google[this.b] &&
          ...
          (c += "&sig=" + encodeURIComponent(google[this.b].JSHash));
        b = [];
      ...
      if (b)
        if ("string" == typeof b) c = [a.packages];
          ...
          for (c = [], a = 0; a < b.length; a++)
            "string" == typeof b[a] &&
              c.push(b[a].replace(/^\s*|\s*$/, "").toLowerCase());
      c || (c = ["default"]);
      b = [];
    ...
    P.prototype.load = function (a, b) {
      ...
      for (var f = [], h = c.length - 1; 0 <= h; h--) {
        ...
        d && e.R(k);
        this.l[":" + k]
          ? (c.splice(h, 1), d && this.g[":" + k].push(e))
          : f.push(k);
      }
      if (c.length) {
        ...
        if (
          ...
          for (var B in a.properties)
            B &&
              ":" == B.charAt(0) &&
              (google[this.b][B.substring(1)] = a.properties[B]);
          google.loader.f(
            "script",
            google.loader.ServiceBase + a.path + a.js,
            d
          );
          a.css &&
            google.loader.f(
              "css",
              google.loader.ServiceBase + a.path + a.css,
              d
            );
        }
        this.s &&
    ...
    P.prototype.o = function (a) {
      -1 != this.c &&
        (S("al_" + this.b, "jl." + (new Date().getTime() - this.c), !0),
        (this.c = -1));
    ...
    Q.prototype.load = function (a, b) {
      ...
      c
        ? (this.m.push(b.callback),
          (b.callback = "google.loader.callbacks." + this.name))
        : (this.j = !0);
    ...
    var T = function (a, b) {
      return a.string
        ? encodeURIComponent(a.string) + "=" + encodeURIComponent(b)
        : a.regex
        ? b.replace(/(^.*$)/, a.regex)
        : "";
    };
      ...
      if (null != c)
        for (var e in c)
          a.params[e]
            ...
            ? (d += "&" + c[e])
            : "base_domain" == e &&
              (b = "http://" + c[e] + a.uri.substring(a.uri.indexOf("/", 7)));
      google[this.name] = {};
    ...
    var U = !1,
        ...
        if (
          ...
          for (var c = 0; c < a.length; c++)
            a[c] = encodeURIComponent(
              a[c].toLowerCase().replace(/[^a-z0-9_.]+/g, "_")
            );
          for (c = 0; c < b.length; c++)
            b[c] = encodeURIComponent(
              b[c].toLowerCase().replace(/[^a-z0-9_.]+/g, "_")
            );
          window.setTimeout(
            C(
              Y,
      ...
      S = function (a, b, c) {
        c
          ...
          : (X(),
            V.push(
              "r" + V.length + "=" + encodeURIComponent(a + (b ? "|" + b : ""))
            ),
