...
export class AdminOurTeamComponent implements OnInit {
  ...
  path: string = AppConstants.OUR_TEAM_MODULE.FETCH_URL;
  ...
  constructor(private global: GlobalFunctionsService, private router: Router) {
    ...
    this.permissions.add = this.global.checkForUserButtonPermission(
      AppConstants.OUR_TEAM_MODULE.ADD_BUTTON
    );
    this.permissions.edit = this.global.checkForUserButtonPermission(
      AppConstants.OUR_TEAM_MODULE.EDIT_BUTTON
    );
    this.permissions.deactivate = this.global.checkForUserButtonPermission(
      AppConstants.OUR_TEAM_MODULE.DEACTIVATE_BUTTON
    );
    this.permissions.activate = this.global.checkForUserButtonPermission(
      AppConstants.OUR_TEAM_MODULE.ACTIVATE_BUTTON
    );

    this.permissions.add_url = AppConstants.OUR_TEAM_MODULE.ADD_URL;
    this.permissions.edit_url = AppConstants.OUR_TEAM_MODULE.EDIT_URL;
    this.permissions.deactivate_url =
      AppConstants.OUR_TEAM_MODULE.DEACTIVATE_URL;
    this.permissions.activate_url = AppConstants.OUR_TEAM_MODULE.ACTIVATE_URL;
  }
  ngOnInit(): void {}
}
