...
@Component({
  selector: 'app-admin-commission-bhrc',
  templateUrl: './admin-commission-bhrc.component.html',
  styleUrls: ['./admin-commission-bhrc.component.scss'],
})
export class AdminCommissionBhrcComponent implements OnInit {
  page = new Page(
    0,
    0,
    0,
  ...
  path: string = AppConstants.BHRC_MODULE.FETCH_URL;
  ...
  constructor(private global: GlobalFunctionsService, private router: Router) {
    ...
    this.permissions.add = this.global.checkForUserButtonPermission(
      AppConstants.BHRC_MODULE.ADD_BUTTON
    );
    this.permissions.edit = this.global.checkForUserButtonPermission(
      AppConstants.BHRC_MODULE.EDIT_BUTTON
    );
    this.permissions.delete = this.global.checkForUserButtonPermission(
      AppConstants.BHRC_MODULE.DELETE_BUTTON
    );
    this.permissions.view = this.global.checkForUserButtonPermission(
      AppConstants.BHRC_MODULE.VIEW_BUTTON
    );

    this.permissions.add_url = AppConstants.BHRC_MODULE.ADD_URL;
    this.permissions.edit_url = AppConstants.BHRC_MODULE.EDIT_URL;
    this.permissions.delete_url = AppConstants.BHRC_MODULE.DELETE_URL;
    this.permissions.view_url = AppConstants.BHRC_MODULE.VIEW_URL;
  }
  ngOnInit(): void {}
}
