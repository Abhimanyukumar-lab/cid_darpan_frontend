...
@Component({
  selector: 'app-admin-commission-nhrc',
  templateUrl: './admin-commission-nhrc.component.html',
  styleUrls: ['./admin-commission-nhrc.component.scss'],
})
export class AdminCommissionNHRCComponent implements OnInit {
  page = new Page(
    0,
    0,
    0,
  ...
  path: string = AppConstants.NHRC_MODULE.FETCH_URL;
  ...
  constructor(private global: GlobalFunctionsService, private router: Router) {
    ...
    this.permissions.add = this.global.checkForUserButtonPermission(
      AppConstants.NHRC_MODULE.ADD_BUTTON
    );
    this.permissions.edit = this.global.checkForUserButtonPermission(
      AppConstants.NHRC_MODULE.EDIT_BUTTON
    );
    this.permissions.delete = this.global.checkForUserButtonPermission(
      AppConstants.NHRC_MODULE.DELETE_BUTTON
    );
    this.permissions.view = this.global.checkForUserButtonPermission(
      AppConstants.NHRC_MODULE.VIEW_BUTTON
    );

    this.permissions.add_url = AppConstants.NHRC_MODULE.ADD_URL;
    this.permissions.edit_url = AppConstants.NHRC_MODULE.EDIT_URL;
    this.permissions.delete_url = AppConstants.NHRC_MODULE.DELETE_URL;
    this.permissions.view_url = AppConstants.NHRC_MODULE.VIEW_URL;
  }
  ngOnInit(): void {}
}
