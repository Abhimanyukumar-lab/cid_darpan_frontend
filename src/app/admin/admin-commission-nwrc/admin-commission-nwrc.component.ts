...
@Component({
  selector: 'app-admin-commission-nwrc',
  templateUrl: './admin-commission-nwrc.component.html',
  styleUrls: ['./admin-commission-nwrc.component.scss'],
})
export class AdminCommissionNwrcComponent implements OnInit {
  page = new Page(
    0,
    0,
    0,
  ...
  path: string = AppConstants.NWRC_MODULE.FETCH_URL;
  ...
  constructor(private global: GlobalFunctionsService, private router: Router) {
    ...
    this.permissions.add = this.global.checkForUserButtonPermission(
      AppConstants.NWRC_MODULE.ADD_BUTTON
    );
    this.permissions.edit = this.global.checkForUserButtonPermission(
      AppConstants.NWRC_MODULE.EDIT_BUTTON
    );
    this.permissions.delete = this.global.checkForUserButtonPermission(
      AppConstants.NWRC_MODULE.DELETE_BUTTON
    );
    this.permissions.view = this.global.checkForUserButtonPermission(
      AppConstants.NWRC_MODULE.VIEW_BUTTON
    );

    this.permissions.add_url = AppConstants.NWRC_MODULE.ADD_URL;
    this.permissions.edit_url = AppConstants.NWRC_MODULE.EDIT_URL;
    this.permissions.delete_url = AppConstants.NWRC_MODULE.DELETE_URL;
    this.permissions.view_url = AppConstants.NWRC_MODULE.VIEW_URL;
  }
  ngOnInit(): void {}
}
