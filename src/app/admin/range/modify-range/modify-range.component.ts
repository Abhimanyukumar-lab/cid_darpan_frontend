...
@Component({
  selector: 'app-modify-range',
  templateUrl: './modify-range.component.html',
  styleUrls: ['./modify-range.component.scss']
})
export class ModifyRangeComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    .subscribe((data) => {
      this.RangeList = data.stateDTOs;
    });

    if (this.entry) {
        
        this.ENTRY_PARAMS.id = this.entry.id;
        this.ENTRY_PARAMS.stateId = this.entry.stateId;
        this.ENTRY_PARAMS.rangeName = this.entry.rangeName;
        this.ENTRY_PARAMS.rangeNameHi = this.entry.rangeNameHi;
  ...
  initiateForm = () => {
    this.entryForm = this.fb.group({
      ...
      rangeName: [
        this.ENTRY_PARAMS.rangeName,
        Validators.compose([Validators.required]),
      ],
      rangeNameHi: [
        this.ENTRY_PARAMS.rangeNameHi,
      ],
  ...
  saveBasicDetails(): void {
    ...
    formData.append('stateId', this.entryForm.value['stateId']);
    formData.append('rangeName', this.entryForm.value['rangeName']);
    formData.append('rangeNameHi', this.entryForm.value['rangeNameHi']);
