...
export class AdminActsComponent implements OnInit {
  page = new Page(
    ...
    true,
    [{ prop: 'id', dir: 'desc' }],
    new Forms(true, null, null, null, null, null, null, 'ACTS')
  );
  ...
  path: string = AppConstants.ACTS_MODULE.FETCH_URL;
  ...
  constructor(private global: GlobalFunctionsService, private router: Router) {
    ...
    this.permissions.add = this.global.checkForUserButtonPermission(
      AppConstants.ACTS_MODULE.ADD_BUTTON
    );
    this.permissions.edit = this.global.checkForUserButtonPermission(
      AppConstants.ACTS_MODULE.EDIT_BUTTON
    );
    this.permissions.deactivate = this.global.checkForUserButtonPermission(
      AppConstants.ACTS_MODULE.DEACTIVATE_BUTTON
    );
    this.permissions.activate = this.global.checkForUserButtonPermission(
      AppConstants.ACTS_MODULE.ACTIVATE_BUTTON
    );

    this.permissions.add_url = AppConstants.ACTS_MODULE.ADD_URL;
    this.permissions.edit_url = AppConstants.ACTS_MODULE.EDIT_URL;
    this.permissions.deactivate_url = AppConstants.ACTS_MODULE.DEACTIVATE_URL;
    this.permissions.activate_url = AppConstants.ACTS_MODULE.ACTIVATE_URL;
  }
  ngOnInit(): void {}
}
