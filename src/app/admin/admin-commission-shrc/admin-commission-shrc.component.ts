...
@Component({
  selector: 'app-admin-commission-shrc',
  templateUrl: './admin-commission-shrc.component.html',
  styleUrls: ['./admin-commission-shrc.component.scss'],
})
export class AdminCommissionShrcComponent implements OnInit {
  page = new Page(
    0,
    0,
    0,
  ...
  path: string = AppConstants.SHRC_MODULE.FETCH_URL;
  ...
  constructor(private global: GlobalFunctionsService, private router: Router) {
    ...
    this.permissions.add = this.global.checkForUserButtonPermission(
      AppConstants.SHRC_MODULE.ADD_BUTTON
    );
    this.permissions.edit = this.global.checkForUserButtonPermission(
      AppConstants.SHRC_MODULE.EDIT_BUTTON
    );
    this.permissions.delete = this.global.checkForUserButtonPermission(
      AppConstants.SHRC_MODULE.DELETE_BUTTON
    );
    this.permissions.view = this.global.checkForUserButtonPermission(
      AppConstants.SHRC_MODULE.VIEW_BUTTON
    );

    this.permissions.add_url = AppConstants.SHRC_MODULE.ADD_URL;
    this.permissions.edit_url = AppConstants.SHRC_MODULE.EDIT_URL;
    this.permissions.delete_url = AppConstants.SHRC_MODULE.DELETE_URL;
    this.permissions.view_url = AppConstants.SHRC_MODULE.VIEW_URL;
  }
  ngOnInit(): void {}
}
