...
@Component({
  selector: 'app-admin-commission-swrc',
  templateUrl: './admin-commission-swrc.component.html',
  styleUrls: ['./admin-commission-swrc.component.scss'],
})
export class AdminCommissionSwrcComponent implements OnInit {
  page = new Page(
    0,
    0,
    0,
  ...
  path: string = AppConstants.SWRC_MODULE.FETCH_URL;
  ...
  constructor(private global: GlobalFunctionsService, private router: Router) {
    ...
    this.permissions.add = this.global.checkForUserButtonPermission(
      AppConstants.SWRC_MODULE.ADD_BUTTON
    );
    this.permissions.edit = this.global.checkForUserButtonPermission(
      AppConstants.SWRC_MODULE.EDIT_BUTTON
    );
    this.permissions.delete = this.global.checkForUserButtonPermission(
      AppConstants.SWRC_MODULE.DELETE_BUTTON
    );
    this.permissions.view = this.global.checkForUserButtonPermission(
      AppConstants.SWRC_MODULE.VIEW_BUTTON
    );

    this.permissions.add_url = AppConstants.SWRC_MODULE.ADD_URL;
    this.permissions.edit_url = AppConstants.SWRC_MODULE.EDIT_URL;
    this.permissions.delete_url = AppConstants.SWRC_MODULE.DELETE_URL;
    this.permissions.view_url = AppConstants.SWRC_MODULE.VIEW_URL;
  }
  ngOnInit(): void {}
}
