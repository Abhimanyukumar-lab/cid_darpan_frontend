...
@Component({
  selector: 'app-gr-attachment',
  templateUrl: './gr-attachment.component.html',
  styleUrls: ['./gr-attachment.component.scss']
})
export class GrAttachmentComponent implements OnInit {
