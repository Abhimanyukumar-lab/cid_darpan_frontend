...
@Component({
  ...
  styleUrls: ['./modify-state.component.scss']
})
export class ModifyStateComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    if (this.entry) {
        ...
        this.ENTRY_PARAMS.stateName = this.entry.stateName;
        this.ENTRY_PARAMS.stateNameHi = this.entry.stateNameHi;
  ...
  initiateForm = () => {
    this.entryForm = this.fb.group({
      ...
      stateName: [
        this.ENTRY_PARAMS.stateName,
        Validators.compose([Validators.required]),
      ],
      stateNameHi: [
        this.ENTRY_PARAMS.stateNameHi,
        Validators.compose([Validators.required]),
      ],
