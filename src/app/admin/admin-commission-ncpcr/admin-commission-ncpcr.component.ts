...
@Component({
  selector: 'app-admin-commission-ncpcr',
  templateUrl: './admin-commission-ncpcr.component.html',
  styleUrls: ['./admin-commission-ncpcr.component.scss']
})
export class AdminCommissionNcpcrComponent implements OnInit {
  ...
  path: string = AppConstants.NCPCR_MODULE.FETCH_URL;
  ...
  constructor(private global: GlobalFunctionsService, private router: Router) {
    ...
    this.permissions.add = this.global.checkForUserButtonPermission(
      AppConstants.NCPCR_MODULE.ADD_BUTTON
    );
    this.permissions.edit = this.global.checkForUserButtonPermission(
      AppConstants.NCPCR_MODULE.EDIT_BUTTON
    );
    this.permissions.delete = this.global.checkForUserButtonPermission(
      AppConstants.NCPCR_MODULE.DELETE_BUTTON
    );
    this.permissions.view = this.global.checkForUserButtonPermission(
      AppConstants.NCPCR_MODULE.VIEW_BUTTON
    );

    this.permissions.add_url = AppConstants.NCPCR_MODULE.ADD_URL;
    this.permissions.edit_url = AppConstants.NCPCR_MODULE.EDIT_URL;
    this.permissions.delete_url = AppConstants.NCPCR_MODULE.DELETE_URL;
    this.permissions.view_url = AppConstants.NCPCR_MODULE.VIEW_URL;
  }
  ngOnInit(): void {}
}
