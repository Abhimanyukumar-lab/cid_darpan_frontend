...
@Component({
  selector: 'app-admin-commission-ncobc',
  templateUrl: './admin-commission-ncobc.component.html',
  styleUrls: ['./admin-commission-ncobc.component.scss'],
})
export class AdminCommissionNcobcComponent implements OnInit {
  page = new Page(
    0,
    0,
    0,
  ...
  path: string = AppConstants.NCOBC_MODULE.FETCH_URL;
  ...
  constructor(private global: GlobalFunctionsService, private router: Router) {
    ...
    this.permissions.add = this.global.checkForUserButtonPermission(
      AppConstants.NCOBC_MODULE.ADD_BUTTON
    );
    this.permissions.edit = this.global.checkForUserButtonPermission(
      AppConstants.NCOBC_MODULE.EDIT_BUTTON
    );
    this.permissions.delete = this.global.checkForUserButtonPermission(
      AppConstants.NCOBC_MODULE.DELETE_BUTTON
    );
    this.permissions.view = this.global.checkForUserButtonPermission(
      AppConstants.NCOBC_MODULE.VIEW_BUTTON
    );

    this.permissions.add_url = AppConstants.NCOBC_MODULE.ADD_URL;
    this.permissions.edit_url = AppConstants.NCOBC_MODULE.EDIT_URL;
    this.permissions.delete_url = AppConstants.NCOBC_MODULE.DELETE_URL;
    this.permissions.view_url = AppConstants.NCOBC_MODULE.VIEW_URL;
  }
  ngOnInit(): void {}
}
