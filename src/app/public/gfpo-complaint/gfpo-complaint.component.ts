...
@Component({
  selector: 'app-gfpo-complaint',
  templateUrl: './gfpo-complaint.component.html',
  styleUrls: ['./gfpo-complaint.component.scss'],
})
export class GfpoComplaintComponent implements OnInit, OnDestroy {
  subscription: any;
  ...
  submit = () => {
    ...
    this.apiCaller
      .apiFormDataPostCall(
        AppConstants.PUBLIC_APIS.GFPO_COMPLAINTADD,
        formData,
        false
      )
      .subscribe(
  ...
  submitData = () => {
    ...
    this.apiCaller
      .apiPostCall(
        AppConstants.PUBLIC_APIS.GFPO_COMPLAINT_OTP_CHECKSTATUS,
  ...
  submitOTPData = () => {
    ...
    this.apiCaller
      .apiPostCall(
        AppConstants.PUBLIC_APIS.GFPO_COMPLAINT_CHECKSTATUS,
        data,
        false,
        false,
        false
